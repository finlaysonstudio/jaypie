...
I made a change to my mock I regret.

The change I regret is removing the named exports:
...
And `export` in front of every function.
...
I would like to restore this but not lose any new mocks that were added.
If there are new mocks, let's make sure to export them in both ways.
Don't worry about tests passing.
