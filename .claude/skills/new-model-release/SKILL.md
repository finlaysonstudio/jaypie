...
`MODEL` is flat for first-class providers. Anthropic, Google, Meta, OpenAI, and xAI ids are top-level keys; `FIREWORKS`, `MISTRAL`, and `OPENROUTER` are nested subtrees.
