/**
 * Index Types for @jaypie/vocabulary
 *
...
/**
 * Index field - can be a BaseEntity field name or custom field
 */
export type IndexField = keyof BaseEntity | string;
...
export interface IndexDefinition {
  ...
  sk?: IndexField[];
  /** Only create index key when ALL pk fields are present on entity */
  sparse?: boolean;
}
...
/**
 * Suffix appended to index keys when entity is archived
 */
export const ARCHIVED_SUFFIX = "#archived";

/**
 * Suffix appended to index keys when entity is deleted
 */
