...
describe("Status Type", () => {
  ...
  describe("StatusType", () => {
    ...
    it("can be used as a validated string type in serviceHandler", async () => {
      // Import serviceHandler to test integration
      const { serviceHandler } = await import("../serviceHandler.js");
