...
/**
 * Get the JSON Schema type string for a vocabulary type
 */
function getJsonSchemaType(type: CoercionType): string {
  // Handle constructors
 ...
 */
function getArrayItemType(type: CoercionType): string | undefined {
 ...
 */
function getEnumValues(type: CoercionType): unknown[] | undefined {
