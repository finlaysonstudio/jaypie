// Create Commander.js options from serviceHandler config
 ...
 */
function isVariadicType(type: CoercionType): boolean {
...
/**
 * Create Commander.js Option objects from a serviceHandler config
 *
 * @param input - The input field definitions from a serviceHandler config
