...
/**
 * Help text for the Datadog service.
 *
 * Inlined rather than read from disk so the text survives the bundled
 * ESM and CJS builds, neither of which ships a sibling markdown file.
 */
export const DATADOG_HELP = `# Datadog Tools
