...
Infrastructure: apigateway, aws, cdk, cicd, datadog, dns, dynamodb, email, express, github, lambda, migrations, ports, secrets, sqs, streaming, variables, waf, web, websockets
