...
export const getSingletonMessage = vi.fn(
...
export const cloneDeep = vi.fn((value: unknown) => structuredClone(value));

export const envBoolean = vi.fn((): boolean => {
  return true;
});

export const envsKey = vi.fn(
  (...params: Parameters<typeof originalEnvsKey>) => {
    try {
...
export const errorFromStatusCode = vi.fn(
...
export const formatError = vi.fn(
...
export const getHeaderFrom = vi.fn(
...
export const getObjectKeyCaseInsensitive = vi.fn(
...
export const isClass = vi.fn(
  (...params: Parameters<typeof originalIsClass>) => {
    try {
...
export const isJaypieError = vi.fn(
...
export const optional = Object.assign(
...
export const safeParseFloat = vi.fn(
...
export const validate = Object.assign(validateFn, {
  array: vi.fn(
    (
...
// @jaypie/express
export const badRequestRoute = vi.fn(
...
export const cors = vi.fn((...params: Parameters<typeof originalCors>) => {
  try {
...
export const echoRoute = vi.fn(
  (...params: Parameters<typeof originalEchoRoute>) => {
    try {
...
export const expressHttpCodeHandler = vi.fn(
...
export const forbiddenRoute = vi.fn(
...
export const goneRoute = vi.fn(
  (...params: Parameters<typeof originalGoneRoute>) => {
    try {
...
export const methodNotAllowedRoute = vi.fn(
...
export const noContentRoute = vi.fn(
...
export const notFoundRoute = vi.fn(
...
export const notImplementedRoute = vi.fn(
...
// @jaypie/llm
export const mockOperate = vi.fn().mockResolvedValue({
  history: [
    {
...
export const mockSend = vi.fn().mockResolvedValue("_MOCK_LLM_RESPONSE");
